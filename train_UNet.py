...
from model.deeplab_UNet import Res_Deeplab
...
# RESTORE_FROM = '/home/ld/github/AdvSemiSeg/snapshots/Liver216.pth'
RESTORE_FROM = None
iter_start = 0
SAVE_NUM_IMAGES = 2
SAVE_PRED_EVERY = 1
SNAPSHOT_DIR = './snapshots_Unet/'
SUMMARY_DIR = './log_Unet/'
WEIGHT_DECAY = 0.0005
