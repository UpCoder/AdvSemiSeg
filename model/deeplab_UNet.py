...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes):
        ...
        self.layer2_upsample = UpSample_Module(512, 256, 101, stride=1)
        self.layer2_upsample_conv = nn.Conv2d(512, 256, kernel_size=1, stride=1, padding=0, bias=False)
        # print(self.layer2)
        self.layer3 = self._make_layer(block, 256, layers[2], stride=1, dilation=2)
        self.layer3_upsample = UpSample_Module(1024, 512, 51, stride=1)
        self.layer3_upsample_conv = nn.Conv2d(1024, 512, kernel_size=1, stride=1, padding=0, bias=False)

        # print(self.layer3)
        self.layer4 = self._make_layer(block, 512, layers[3], stride=1, dilation=4)
        self.layer4_upsample = UpSample_Module(2048, 1024, 51, stride=1)
        self.layer4_upsample_conv = nn.Conv2d(2048, 1024, kernel_size=1, stride=1, padding=0, bias=False)
        # print(self.layer4)
    ...
    def forward(self, x):
        ...
        layer_5 = self.layer5(layer1_output)
...
if __name__ == '__main__':
    ...
    import numpy as np
    data = np.random.random([1, 3, 200, 200])
