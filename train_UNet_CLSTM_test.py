...
from model.deeplab_UNet_CLSTM import Res_Deeplab
...
RESTORE_FROM = '/home/give/github/AdvSemiSeg/snapshots_Unet_CLSTM/Liver4141.pth'
# RESTORE_FROM = None
iter_start = 4141
SAVE_NUM_IMAGES = 2
SAVE_PRED_EVERY = 1
SNAPSHOT_DIR = './snapshots_Unet_CLSTM/'
SUMMARY_DIR = './log_Unet_CLSTM/'
WEIGHT_DECAY = 0.0005
...
def main():
    ...
    # create network
    model = Res_Deeplab(num_classes=args.num_classes, slice_num=n_neighboringslices, gpu_id=0)
